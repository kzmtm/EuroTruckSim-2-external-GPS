...
# Licensing
Currently this is a standalone project, so there are no licenses that I know of.
The image for the site is grabbed from here: 
*https://www.reddit.com/r/trucksim/comments/wtgfaa/i_made_a_map_of_all_named_locations_in_basegame/*

Feel free to make changes, this will be open source. This is also a reason for why the .html is uploaded. 
